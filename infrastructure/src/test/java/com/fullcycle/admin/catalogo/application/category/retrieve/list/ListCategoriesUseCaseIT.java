...
public class ListCategoriesUseCaseIT {
    ...
    void mockUp() {
        final var categories = Stream.of(
                ...
                Category.newCategory("Amazon Originals", "Títulos de Autoria da Amaazon", true),
    ...
    @Test
    public void givenAValidTerm_whenTermMatchesPrePersisted_shouldReturnEmptyPage() {
        final var expectedPage = 0;
        final var expectedPerPage = 10;
        final var expectedTerms = "ji1j31 1j319j";
    ...
    public void givenAValidTerm_whenCallsListCategories_shouldReturnCategoriesFilters(
